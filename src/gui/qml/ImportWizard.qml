...
Item {
    ...
    Rectangle {
        ...
        Column {
            ...
            Text {
                text: "Convert PCK or WEM files to .zzar mod package"
                color: "#888888"
                font.family: "Alatsi"
                font.pixelSize: 14
            }
            ...
            Item {
                ...
                Column {
                    ...
                    Text {
                        text: "Step 1: Select Import Mode"
                        color: "#ffffff"
                        font.family: "Alatsi"
                        font.pixelSize: 18
                        font.bold: false
                    ...
                    Text {
                        text: "What type of mod files do you have?"
                        color: "#aaaaaa"
                        font.family: "Alatsi"
                        font.pixelSize: 14
                    }
                    ...
                    Column {
                        ...
                        Rectangle {
                            ...
                            Row {
                                ...
                                Text {
                                    text: "Single PCK file (modded game archive)"
                                    color: "#ffffff"
                                    font.family: "Alatsi"
                                    font.pixelSize: 16
                                    anchors.verticalCenter: parent.verticalCenter
                        ...
                        Rectangle {
                            ...
                            Row {
                                ...
                                Text {
                                    text: "Folder containing PCK files"
                                    color: "#ffffff"
                                    font.family: "Alatsi"
                                    font.pixelSize: 16
                                    anchors.verticalCenter: parent.verticalCenter
                        ...
                        Rectangle {
                            ...
                            Row {
                                ...
                                Text {
                                    text: "Single WEM file (audio replacement)"
                                    color: "#ffffff"
                                    font.family: "Alatsi"
                                    font.pixelSize: 16
                                    anchors.verticalCenter: parent.verticalCenter
                        ...
                        Rectangle {
                            ...
                            Row {
                                ...
                                Text {
                                    text: "Folder containing WEM files"
                                    color: "#ffffff"
                                    font.family: "Alatsi"
                                    font.pixelSize: 16
                                    anchors.verticalCenter: parent.verticalCenter
                        ...
                        Rectangle {
                            ...
                            Column {
                                ...
                                Text {
                                    text: "PCK files must match the current game version. Using PCK files from a different game version will cause issues, if you dont know what your doing use the WEM file option."
                                    color: "#cc8888"
                                    font.family: "Alatsi"
                                    font.pixelSize: 12
                                    width: parent.width
                ...
                Column {
                    ...
                    Row {
                        ...
                        Text {
                            text: importMode.indexOf("folder") >= 0 ? "Folder:" : "File(s):"
                            color: "#aaaaaa"
                            font.family: "Alatsi"
                            font.pixelSize: 14
                            anchors.verticalCenter: parent.verticalCenter
                ...
                Column {
                    ...
                    Text {
                        text: "Step 3: Review Detected Files"
                        color: "#ffffff"
                        font.family: "Alatsi"
                        font.pixelSize: 18
                        font.bold: false
                    ...
                    Text {
                        text: "The following files will be included in the mod:"
                        color: "#aaaaaa"
                        font.family: "Alatsi"
                        font.pixelSize: 14
                    }
                ...
                Column {
                    ...
                    Text {
                        text: "Enter information about this mod:"
                        color: "#aaaaaa"
                        font.family: "Alatsi"
                        font.pixelSize: 14
                    }
                            ...
                            Column {
                                ...
                                Rectangle {
                                    ...
                                    TextInput {
                                        ...
                                        Text {
                                            anchors.fill: parent
                                            text: "Describe what this mod does..."
                                            color: "#555555"
                                            font.family: "Alatsi"
                                            font.pixelSize: 14
                            ...
                            Row {
                                ...
                                Rectangle {
                                    ...
                                    Text {
                                        anchors.fill: parent
                                        anchors.margins: 8
                                        text: thumbnailPath ? thumbnailPath.split("/").pop() : "Optional - Browse for image"
    ...
    function goNext() {
        ...
        if (currentPage === 2) {
            var summary = "Files to be included in the mod:\n\n"
